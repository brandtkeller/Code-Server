...
RUN sudo apt-get update && sudo apt-get install -y python python3-pip ffmpeg libpq-dev apt-transport-https gnupg build-essential manpages-dev software-properties-common ansible
